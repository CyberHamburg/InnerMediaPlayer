...
namespace LitJson
{
    ...
    public class JsonMapper
    {
        ...
        private static void WriteValue (object obj, JsonWriter writer,
                                        ...
                                        int depth,bool skipNullValue = false)
        {
            ...
            if (obj is Array) {
                ...
                foreach (object elem in (Array) obj)
                    WriteValue (elem, writer, writer_is_private, depth + 1, skipNullValue);
            ...
            foreach (PropertyMetadata p_data in props) {
                var skipAttributesList = p_data.Info.GetCustomAttributes(typeof(Extension.JsonIgnoreAttribute), true);
                ...
                if (p_data.IsField)
                {
                    ...
                    if (skipNullValue&&p_info.GetValue(obj)==null)
                    {
                        continue;
                    }
                    writer.WritePropertyName (p_data.Info.Name);
                    WriteValue (p_info.GetValue (obj),
                                writer, writer_is_private, depth + 1,skipNullValue);
                }
                else {
        ...
        public static string ToJson(object obj, bool skipNullValue = false)
        {
            lock (static_writer_lock)
            {
                static_writer.Reset();

                WriteValue(obj, static_writer, true, 0, skipNullValue);

                return static_writer.ToString();
            }
        }

        public static void ToJson (object obj, JsonWriter writer,bool skipNullValue = false)
        {
            WriteValue (obj, writer, false, 0, skipNullValue);
        }
